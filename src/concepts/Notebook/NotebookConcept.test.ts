...
import NotebookConcept, { type NotebookDocument } from "./NotebookConcept.ts";
...
Deno.test("Notebook Concept", async (t) => {
  ...
  await t.step(
    ...
    async () => {
      ...
      console.log(
        `Action: createNotebook(${userA}, "Alice's Recipes") -> ${notebookId}`,
      );

      const retrieved = await notebookConcept._getNotebookById({
        notebook: notebookId,
      });
      assertEquals(
        (retrieved as { error: string }).error,
        undefined,
        "Should retrieve notebook without error",
      );
      assertEquals(
        (retrieved as NotebookDocument[]).length,
        1,
        "Should retrieve one notebook",
      );
      ...
      assertEquals(
        notebook.recipes.length,
        0,
        "New notebook should have no recipes",
      );
      assertNotEquals(
        notebook.created,
        undefined,
  ...
  await t.step(
    ...
    async () => {
      const res1 = await notebookConcept.createNotebook({
        owner: userA,
        title: "Alice's Main Cookbook",
      });
      aliceNotebookId = (res1 as { notebook: ID }).notebook;
      const res2 = await notebookConcept.createNotebook({
        owner: userB,
        title: "Bob's Baking Book",
      });
      bobNotebookId = (res2 as { notebook: ID }).notebook;
      console.log(
        `Setup: Alice's notebook ${aliceNotebookId}, Bob's notebook ${bobNotebookId}`,
      );
    },
  );
  ...
  await t.step(
    ...
    async () => {
      ...
      const result = await notebookConcept.inviteMember({
        owner: userA,
        notebook: aliceNotebookId,
        member: userB,
      });
      assertEquals(
        (result as { error: string }).error,
      ...
      console.log(
        `Action: inviteMember(${userA}, ${aliceNotebookId}, ${userB})`,
      );

      const notebook = (
        (await notebookConcept._getNotebookById({
          notebook: aliceNotebookId,
        })) as any[]
      )[0];
      assertArrayIncludes(
        notebook.members,
        [userA, userB],
        "User B should be a member of Alice's notebook",
      );
  ...
  await t.step("inviteMember: should return error if not owner", async () => {
    ...
    assertEquals(
      (result as { error: string }).error,
      "Only the notebook owner can invite members.",
      "Should return error for non-owner inviting",
    );
    console.log(
  ...
  await t.step(
    ...
    async () => {
      ...
      assertEquals(
        (result as { error: string }).error,
        "User is already a member of this notebook.",
        "Should return error for inviting existing member",
      );
      console.log(
  ...
  await t.step(
    ...
    async () => {
      ...
      const result = await notebookConcept.removeMember({
        owner: userA,
        notebook: aliceNotebookId,
        member: userB,
      });
      ...
      console.log(
        `Action: removeMember(${userA}, ${aliceNotebookId}, ${userB})`,
      );
      ...
      assertEquals(
        notebook.members.includes(userB),
        false,
        "User B should no longer be a member",
      );
      assertEquals(
        notebook.members.length,
        1,
        "There should be 1 member (owner A)",
      );
  ...
  await t.step("removeMember: should return error if not owner", async () => {
    ...
    await notebookConcept.inviteMember({
      owner: userA,
      notebook: aliceNotebookId,
      member: userB,
    }); // Re-add userB for this test
    const result = await notebookConcept.removeMember({
      owner: userC,
      notebook: aliceNotebookId,
      member: userB,
    ...
    assertEquals(
      (result as { error: string }).error,
      "Only the notebook owner can remove members.",
      "Should return error for non-owner removing",
    );
    console.log(
      "Requirement: owner = notebook.owner is enforced. Action failed as expected.",
    );
  ...
  await t.step(
    ...
    async () => {
      ...
      assertEquals(
        (result as { error: string }).error,
        "The owner cannot remove themselves from the notebook.",
        "Should return error for owner removing self",
      );
      console.log(
  ...
  await t.step(
    ...
    async () => {
      ...
      assertEquals(
        (result as { error: string }).error,
        "User is not a member of this notebook.",
        "Should return error if member is not in notebook",
      );
      console.log(
  ...
  await t.step(
    ...
    async () => {
      ...
      const result = await notebookConcept.shareRecipe({
        sharer: userA,
        recipe: recipe1,
        notebook: aliceNotebookId,
      });
      ...
      console.log(
        `Action: shareRecipe(${userA}, ${recipe1}, ${aliceNotebookId})`,
      );
      ...
      assertArrayIncludes(
        notebook.recipes,
        [recipe1],
        "Recipe 1 should be shared in Alice's notebook",
      );
  ...
  await t.step(
    ...
    async () => {
      ...
      assertEquals(
        (result as { error: string }).error,
        "Recipe is already shared in this notebook.",
        "Should return error for already shared recipe",
      );
      console.log(
  ...
  await t.step(
    ...
    async () => {
      ...
      const result = await notebookConcept.unshareRecipe({
        requester: userA,
        recipe: recipe1,
        notebook: aliceNotebookId,
      });
      ...
      console.log(
        `Action: unshareRecipe(${userA}, ${recipe1}, ${aliceNotebookId})`,
      );
      ...
      assertEquals(
        notebook.recipes.includes(recipe1),
        false,
        "Recipe 1 should no longer be in Alice's notebook",
      );
      console.log(
  ...
  await t.step(
    ...
    async () => {
      ...
      assertEquals(
        (result as { error: string }).error,
        "Recipe is not shared in this notebook.",
        "Should return error for unsharing unshared recipe",
      );
      console.log(
  ...
  await t.step(
    ...
    async () => {
      ...
      const result = await notebookConcept.deleteNotebook({
        owner: userB,
        notebook: bobNotebookId,
      }); // Bob is owner of his notebook.
      assertEquals(
        (result as { error: string }).error,
        undefined,
        "Should not return an error",
      ...
      assertEquals(
        (retrieved as { error: string }).error,
        "Notebook not found.",
        "Should return error for deleted notebook",
      );
  ...
  await t.step("deleteNotebook: should return error if not owner", async () => {
    ...
    assertEquals(
      ...
      "Should return error for non-owner deleting",
    );
    console.log(
      "Requirement: owner = notebook.owner is enforced. Action failed as expected.",
    );
  ...
  await t.step(
    ...
    async () => {
      ...
      console.log(
        `   Action: createNotebook(${vivien}, "Roommate Meals") -> ${vivienNotebookId}`,
      );

      console.log("2. Vivien invites roommates to the notebook.");
      await notebookConcept.inviteMember({
        owner: vivien,
        notebook: vivienNotebookId,
        member: roommate1,
      });
      await notebookConcept.inviteMember({
        owner: vivien,
      ...
      console.log(
        `   Actions: inviteMember(${vivien}, ${vivienNotebookId}, ${roommate1})`,
      );
      console.log(
        `            inviteMember(${vivien}, ${vivienNotebookId}, ${roommate2})`,
      );
      ...
      assertArrayIncludes(
        notebookDoc.members,
        [vivien, roommate1, roommate2],
        "All roommates should be members",
      );
      ...
      await notebookConcept.shareRecipe({
        sharer: vivien,
        recipe: matchaBrownies,
        notebook: vivienNotebookId,
      });
      console.log(
        `   Action: shareRecipe(${vivien}, ${matchaBrownies}, ${vivienNotebookId})`,
      );
      ...
      assertArrayIncludes(
        notebookDoc.recipes,
        [matchaBrownies],
        "Matcha Brownies should be in the notebook",
      );
      ...
      await notebookConcept.shareRecipe({
        sharer: roommate1,
        recipe: pastaCarbonara,
        notebook: vivienNotebookId,
      });
      console.log(
        `   Action: shareRecipe(${roommate1}, ${pastaCarbonara}, ${vivienNotebookId})`,
      );
      ...
      assertArrayIncludes(
        notebookDoc.recipes,
        [matchaBrownies, pastaCarbonara],
        "Both recipes should be in the notebook",
      );
      ...
      const vivienNotebooks = await notebookConcept._getNotebooksWithMember({
        member: vivien,
      });
      assertEquals(
        (vivienNotebooks as NotebookDocument[]).length,
        1,
        "Vivien should see her notebook",
      );
      assertArrayIncludes(
        (vivienNotebooks as NotebookDocument[])[0].recipes,
        [matchaBrownies, pastaCarbonara],
        "Vivien can view all shared recipes.",
      );
      console.log(
        `   Query: _getNotebooksWithMember(${vivien}) -> Vivien sees notebook with recipes.`,
      );

      const roommate1Notebooks = await notebookConcept._getNotebooksWithMember({
        member: roommate1,
      });
      assertEquals(
        (roommate1Notebooks as NotebookDocument[]).length,
        1,
        "Roommate 1 should see the shared notebook",
      );
      assertArrayIncludes(
        (roommate1Notebooks as NotebookDocument[])[0].recipes,
        [matchaBrownies, pastaCarbonara],
        "Roommate 1 can view all shared recipes.",
      );
      console.log(
        `   Query: _getNotebooksWithMember(${roommate1}) -> Roommate 1 sees notebook with recipes.`,
      );

      const roommate2Notebooks = await notebookConcept._getNotebooksWithMember({
        member: roommate2,
      });
      assertEquals(
        (roommate2Notebooks as NotebookDocument[]).length,
        1,
        "Roommate 2 should see the shared notebook",
      );
      assertArrayIncludes(
        (roommate2Notebooks as NotebookDocument[])[0].recipes,
        [matchaBrownies, pastaCarbonara],
        "Roommate 2 can view all shared recipes.",
      );
      console.log(
        `   Query: _getNotebooksWithMember(${roommate2}) -> Roommate 2 sees notebook with recipes.`,
      );
